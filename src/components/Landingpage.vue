<template>
  <div>
    <div class="site-wrap">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-6 col-xl-2">
              <h1 class="mb-0 site-logo">
                <router-link :to="{name:'Index'}" class="amado-navbar-brand">
                    <h2>Censored</h2>
                </router-link>
              </h1>
            </div>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(static/landingpage/images/hero_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              ...
              <div class="row mb-4">
                <div class="col-md-7">
                  ...
                  <div>
                    <router-link :to="{name:'Index'}" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 mb-lg-0 mb-2 d-block d-sm-inline-block">
                        Shop Now
                    </router-link>
